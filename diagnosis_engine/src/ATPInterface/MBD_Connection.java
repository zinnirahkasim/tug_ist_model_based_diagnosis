...
public class MBD_Connection{
   ...
   public MBD_Connection(Map openSessions, boolean verboseOutput) {
        //this.SD = SD;
   ...
   public void run(String SD) {
        ...
        try {
            ...
            //String SD = 
            //BufferedReader reader = new BufferedReader(new FileReader("SD.txt"));
